...
hash_table_file = "hash_table_cqt.json"

def extract_features(audio_signal, sample_rate):
    # Extract features (e.g., chroma features) from the audio signal using Constant-Q Transform (CQT)
    features = librosa.feature.chroma_cqt(y=audio_signal, sr=sample_rate)
    return features
...
def main():
    ...
    # Extract features from the denoised audio using CQT
